...
| [fact-check](fact-check.md) | Verify empirical claims and apply corrections | file path, --report-only | 2.1.0 |
| [proof](proof.md) | Proofread documents and apply corrections | file path, --report-only | 3.1.0 |
